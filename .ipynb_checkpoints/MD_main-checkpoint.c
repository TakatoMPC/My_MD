...
void Posit(double *rx, double *ry, double *rx0, double *ry0, double *velx, double *vely, double *fx, double *fy, int N0, int NA, double K, double dt); //位置を更新する関数
...
int main(void)
    ...
    for(ti=1;ti<=tiMAX;ti++){
      ...
      Posit(rx, ry, rx0, ry0, velx0, vely0, fx0, fy0, N0, NA, K, dt);
...
void Posit(double *rx, double *ry, double *rx0, double *ry0, double *velx, double *vely, double *fx, double *fy, int N0, int NA, double K, double dt){
  int i;
  double dt2by2;
